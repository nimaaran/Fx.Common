...
/// <summary>
/// A type of specification object created by combining two specifications using the OR operator.
/// </summary>
/// <typeparam name="TEntity">Type of the domain entity.</typeparam>
public sealed class OrSpecification<TEntity> : BaseSpecification<TEntity>, ISpecification<TEntity>
    where TEntity : class, IEntity
{
    ...
    public override Expression<Func<TEntity, bool>> Export()
    {
        ...
        var body = Expression.OrElse(leftExpression.Body, invokedRight);
